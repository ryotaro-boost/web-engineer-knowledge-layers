...
| 代表例 | Eloquent, ActiveRecord, Prisma, GORM, SQLAlchemy ORM | Knex.js, Drizzle, Ecto | database/sql (Go), sqlc, pg |
...
| 代表例 | Ruby on Rails ActiveRecord, Laravel Eloquent | SQLAlchemy (Python), TypeORM/Prisma (TypeScript) |
