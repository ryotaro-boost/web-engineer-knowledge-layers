...
**UUID v4 の問題:** ランダム値のため、B-Tree [[Resources/Study/Layer3-データ永続化/インデックス|インデックス]]への挿入がランダムな位置になり、ページ分割が頻発する。大量データでは連番型と比較して INSERT 性能が著しく低下する。
...
- [[Resources/Study/Layer3-データ永続化/インデックス|インデックス]] — UUID v4 vs v7 のB-Tree性能差を理解するにはインデックスの内部構造の知識が必要
